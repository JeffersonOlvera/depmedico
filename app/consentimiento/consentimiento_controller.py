...
class ConsentimientoController:
    ...
    def cargar(self):
        ...
        try:
                ...
                return render_template(
                    "forms/medico/form_consentimiento_doc.html", errores={}, form_data=form_data
                )
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                if response.status_code == 201:
                    ...
                    pdf_path_input = os.path.join(os.path.dirname(__file__), '..', '..', 'static','files', 'CONSENTIMIENTO_INFORMADO.pdf')
                    ...
                    return render_template('dashboard/dashboard_consentimiento.html', errores={}, form_data=form_data)
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                if response.status_code == 201:
                    ...
                    file_path = os.path.join(os.path.dirname(__file__), '..', '..','static',  'files', 'CONSENTIMIENTO_INFORMADO.xlsx')
                    ...
                    if firma_colaborador:
                        ...
                        try:
                            ...
                            tempxlsx1 = os.path.join(os.path.dirname(__file__), '..','..','static', 'files', 'CONSENTIMIENTOTEMP.png')
