...
class SeguimientoController:
    ...
    def _preparar_payload(self, form_data, usuario):
        ...
        return {
            ...
            "Cedula": form_data.get(session.get("cedula"), "Cedula", ""),
            "Nombre": form_data.get(session.get("nombreColaborador"), "Nombre", ""),
    ...
    def actualizar(self):
        ...
        try:
            ...
            payload = {**form_data, "usuario_actualizacion": usuario, "status": "Completada", "tipo_ficha": "SeguimientoDroga"}
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                if response.status_code == 201:
                    ...
                    pdf_path_input = os.path.join(os.path.dirname(__file__), '..', '..', 'static', 'files', 'FICHA_SEGUIMIENTO.pdf')
                    ...
                    return render_template('dashboard/dashboard_seguimiento.html', errores={}, form_data=form_data)
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                if response.status_code == 201:
                    ...
                    file_path = os.path.join(os.path.dirname(__file__), '..','..','static', 'files', 'FICHA_SEGUIMIENTO.xlsx')
